...
const personSchema = { '@context': 'https://schema.org', '@type': 'Person', name: site.name, url: siteUrl, sameAs: [site.socials.github, site.socials.twitter, site.socials.linkedin] }
