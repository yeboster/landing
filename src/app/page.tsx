    ...
    <main className="flex-1 overflow-hidden">
      ...
      <section className="w-full py-20 md:py-32 lg:py-40 relative">
        ...
        <div className="flex flex-col items-center justify-center relative z-10 px-4">
          ...
          <motion.p
            className="mt-3 text-base md:text-lg text-gray-400 dark:text-gray-300"
      ...
      {/* Navigation Cards */}
      <section className="w-full py-16 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-500">
              ...
              return (
                ...
                >
                  <Link href={card.href} className="block h-full">
                    <motion.div
                      className="group h-full p-8 rounded-2xl bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-400 transition-all duration-300 cursor-pointer"
