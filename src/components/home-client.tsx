...
function useSpotlight() {
  ...
  return {
    ...
    style: { '--spotlight-x': `${pos.x}%`, '--spotlight-y': `${pos.y}%` } as React.CSSProperties,
  }
}
    ...
    <main className="flex-1 overflow-hidden">
      ...
      <section className="w-full py-14 md:py-20">
        <div className="max-w-5xl mx-auto px-4 md:px-6 grid gap-6 md:grid-cols-2">
          <motion.div
            className="spotlight-card rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-8"
              ...
              return (
                ...
                >
                  <Link href={card.href} className="block h-full">
                    <motion.div
                      className="spotlight-card group h-full p-8 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-[#9f4f9d]/50 dark:hover:border-[#9f4f9d]/50 transition-all duration-300 cursor-pointer"
